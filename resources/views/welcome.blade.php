...
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
    ...
    <section class="relative bg-cover bg-center min-h-screen flex items-center" 
             style="background-image: url('{{ asset('images/kab-bojonegoro.jpg') }}')">
        <div class="bg-black/50 absolute inset-0"></div>
        <div class="relative z-10 max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div class="text-white">
                ...
                <div class="mt-6 flex gap-4">
                    <a href="#about" class="bg-green-900 text-white px-6 py-3 rounded-lg">Tonton Video</a>
                    <a href="tel:+62123456789" class="border border-white px-6 py-3 rounded-lg">+62 123-456-789</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition">
                    <div class="flex items-center mb-4">
                        <h4 class="text-lg font-semibold text-gray-800">Tradisi Sedekah Bumi</h4>
                    </div>
                    <p class="text-gray-600 text-sm">
                        Tradisi yang mencerminkan rasa syukur masyarakat terhadap hasil bumi yang melimpah.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-16 bg-yellow-50">
    ...
    <section class="py-16 bg-yellow-50">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
                <h3 class="text-2xl font-bold text-yellow-700">Tahukah Kamu?</h3>
    ...
    <section class="py-16 bg-yellow-50">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-3xl md:text-4xl font-bold text-yellow-700 text-center">Frequently Asked Questions</h2>
            <div class="mt-8 space-y-4">
                <details class="bg-white p-4 rounded-lg shadow">
                    <summary class="font-semibold cursor-pointer">Apa manfaat pelestarian budaya?</summary>
                    <p class="mt-2 text-gray-600">Pelestarian budaya bermanfaat untuk menjaga warisan leluhur...</p>
                </details>
                <details class="bg-white p-4 rounded-lg shadow">
                    <summary class="font-semibold cursor-pointer">Bagaimana cara ikut serta?</summary>
                    <p class="mt-2 text-gray-600">Anda dapat ikut serta dengan mendukung kegiatan lokal...</p>
                </details>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-blue-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h3 class="font-bold text-lg">SahabatSawit</h3>
                <p class="mt-4 text-sm">Jl. Utama No. 17A <br> Cawang, Kramatjati <br> Jakarta Timur</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="mt-4 text-sm">+62 876 678 76 76 <br> contact@bojonegoromatoh.com</p>
            </div>
            <div>
        ...
        <div class="mt-8 text-center text-sm text-gray-300">© 2024 BojonegoroMatoh | Powered by BojonegoroMatoh</div>
    </footer>
    </body>
</html>
